...
#ContainerInherit and InheritOnly set to satisfy (subkeys only)
$ruleCREATOROWNER = New-Object System.Security.AccessControl.RegistryAccessRule ("CREATOR OWNER","FullControl","ContainerInherit","InheritOnly","Allow")
...
#all machines are 64-bit which satisfies (for 64-bit systems only)
